...
Partial Class ResultLine_LineGLU
    ...
    Public Function PlodLine() As String
        ...
        SqlRef = "SELECT * FROM RefValue WHERE Tcode='CBC01'"
        ...
        SqlPlotChart = "SELECT * FROM PlotChart WHERE cmsID='" & cmsID & "' and Tcode='CBC01' ORDER BY Servicedate"
        Dim dt As DataTable
        ...
        If dt.Rows.Count > 0 Then
            ...
            sScript2 = CBarChart.PlotChart(lstTestP, "PlotID1", "WBC", "ปริมาณเม็ดเลือดขาว", Ref_Value, RMin, RMAX)
        End If
