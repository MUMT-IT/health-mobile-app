<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LineBUN.aspx.vb" Inherits="ResultLine_BUN" %>
<html>
<head runat="server">
...
<body>
   ...
   <div id="PlotID1" style="min-width: 100%; height: 300px; margin: 0 auto" visible="true" ></div>
    <div id="PlotID2" style="min-width: 100%; height: 300px; margin: 0 auto" visible="true" ></div>
